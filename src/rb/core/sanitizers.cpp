...
extern "C" [[maybe_unused]] char const* __asan_default_options(void) { // NOLINT
...
extern "C" [[maybe_unused]] char const* __msan_default_options(void) { // NOLINT
...
// see random::bitGen
extern "C" [[maybe_unused]] char const* __ubsan_default_options(void) { // NOLINT
